<script>
  ...
  let visible = false;
  let typedText = '';
  const phrases = ['full-stack engineer.', 'system designer.', 'problem solver.', 'open-source builder.'];
  let phraseIdx = 0;
  let charIdx = 0;
  let deleting = false;
...
<section class="hero" aria-label="Introduction" id="hero">
  ...
  <div class="hero-content" class:visible>
    ...
    <p class="hero-desc">
      I build <strong>fast</strong>, <strong>scalable</strong>, and <strong>beautifully interactive</strong> web applications
      — from real-time collaborative editors to high-throughput APIs.
    </p>
    ...
    <div class="hero-socials">
      {#each socials as s}
        <a href={s.href} target="_blank" rel="noopener noreferrer" aria-label={s.name} class="social-link">
          {s.label}
        </a>
      {/each}
    </div>
  ...
  <div class="code-float" aria-hidden="true">
    <div class="code-card">
      ...
      <pre class="code-body"><code><span class="kw">const</span> <span class="var">dev</span> = <span class="punct">&#123;</span>
  <span class="key">name</span><span class="punct">:</span> <span class="str">"Alex"</span><span class="punct">,</span>
  <span class="key">role</span><span class="punct">:</span> <span class="str">"Full-Stack"</span><span class="punct">,</span>
  <span class="key">stack</span><span class="punct">:</span> <span class="punct">[</span>
  ...
  <span class="key">available</span><span class="punct">:</span> <span class="bool">true</span>
